...
function buildMetrics(cards: CardRecord[]) {
  ...
  return [
    ...
    { label: "Debit cards", value: String(debitCards.length), note: "Cash access and everyday spend" },
          ...
          <div className="relative flex w-full flex-col gap-8 xl:gap-10">
            ...
            {activeCard ? (
                ...
                <button
                  ...
                  className="mt-5 rounded-full bg-stone-900 px-4 py-2 text-sm text-white"
                >
                  Reset filters
                </button>
              </div>
